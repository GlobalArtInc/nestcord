...
export const {
  ConfigurableModuleClass: NestCordLocalizationConfigurableModule,
  MODULE_OPTIONS_TOKEN: NESTCORD_LOCALIZATION_OPTIONS_TOKEN,
  ...
  .setExtras<NestCordLocalizationOptions>(
    ...
    (definition, extras) => {
      const adapterProvider: Provider = {
        ...
        inject: [NESTCORD_LOCALIZATION_OPTIONS_TOKEN],
      };
