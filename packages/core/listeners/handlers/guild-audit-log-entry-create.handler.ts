...
export type CustomGuildAuditLogEntryCreateEvents = {
  ...
  guildAuditLogEntryWebhookCreate: [auditLogEntry: GuildAuditLogsEntry<AuditLogEvent.WebhookCreate>, guild: Guild];
  guildAuditLogEntryWebhookUpdate: [auditLogEntry: GuildAuditLogsEntry<AuditLogEvent.WebhookUpdate>, guild: Guild];
  guildAuditLogEntryWebhookDelete: [auditLogEntry: GuildAuditLogsEntry<AuditLogEvent.WebhookDelete>, guild: Guild];
};
...
export class GuildAuditLogEntryCreateHandler extends BaseHandler<CustomGuildAuditLogEntryCreateEvents> {
  ...
  public handleGuildAuditLogEntryChanges([auditLogEntry, guild]: ContextOf<'guildAuditLogEntryCreate'>) {
  ...
  @CustomListenerHandler()
  public handleGuildAuditLogEntryWebhookChanges([auditLogEntry, guild]: ContextOf<'guildAuditLogEntryCreate'>) {
