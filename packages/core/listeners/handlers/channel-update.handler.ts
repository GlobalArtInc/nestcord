...
import { DMChannel, GuildChannel, NonThreadGuildBasedChannel, PermissionOverwriteManager } from 'discord.js';
...
export class ChannelUpdateHandler extends BaseHandler<CustomChannelUpdateEvents> {
  ...
  public handleGuildChannelPermissionsUpdate([oldChannel, newChannel]: ContextOf<'channelUpdate'>) {
